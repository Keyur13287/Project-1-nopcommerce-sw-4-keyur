...
public class ComputerTest extends TestBase {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.22 Fill the all mandatory field
        computerPage.sendTextToElement(computerPage.firstName, "keyur");
        computerPage.sendTextToElement(computerPage.lastName, "patel");
        computerPage.sendTextToElement(computerPage.emailId, "keyur@gmail.com");
        computerPage.select(computerPage.country, "133");
        computerPage.sendTextToElement(computerPage.city, "new york");
        computerPage.sendTextToElement(computerPage.address1, "Manr court");
        ...
        //2.28 Fill all the details
        computerPage.sendTextToElement(computerPage.cardHolderName, "keyur patel");
