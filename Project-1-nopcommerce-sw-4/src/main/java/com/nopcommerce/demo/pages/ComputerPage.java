...
//    //By computer = mouseHoverToElement(By.xpath("//ul[@class='top-menu notmobile']//a[normalize-space()='Computers']"));
...
//    By product_items= By.xpath("//h2[@class='product-title']//a");
//
//
//
//    public void clickOnMenuAndHover(){
//        mouseHoverToElement(computer);
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(6));
//        mouseHoverToElementAndClick(desktop);
//    }
//    public void clickOnSortBy(String order){
